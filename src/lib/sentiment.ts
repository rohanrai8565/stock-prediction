...
const POS = [
  "beat","beats","surge","surges","rally","record","upgrade","upgraded","growth","strong","profit",
  "outperform","bullish","expands","wins","raises","optimistic","breakthrough","demand","momentum",
];
const NEG = [
  "miss","misses","plunge","plunges","slump","downgrade","downgraded","lawsuit","probe","weak",
  "loss","losses","recall","bearish","cuts","warns","layoffs","decline","selloff","risk",
];
